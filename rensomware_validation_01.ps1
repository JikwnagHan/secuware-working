...
function Initialize-AreaData {
    ...
    if (-not (Test-Path -LiteralPath $pngPath)) {
        $pngBase64 = @'
iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mP8/x8AAwMBAFdxl3sAAAAASUVORK5CYII=
'@
    ...
    if (-not (Test-Path -LiteralPath $jpgPath)) {
        $jpgBase64 = @'

'@
        [System.IO.File]::WriteAllBytes($jpgPath, [System.Convert]::FromBase64String($jpgBase64))
    }
    ...
    $systemSamples = @(
        ...
        @{ Name = 'policies.reg'; Content = "Windows Registry Editor Version 5.00`n[HKEY_LOCAL_MACHINE\\SOFTWARE\\SampleCompany]`n\"SecureArea\"=\"$AreaName\"" },
