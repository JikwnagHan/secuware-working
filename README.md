...
4. **악성코드 침해 테스트**: Atomic 7개 버킷, 50개 대표 시나리오를 스크립트 내장 동작으로 재현해 파일 변경·생성·속성 조작을 수행하고 파일 단위 결과를 수집합니다.
...
4. 악성행위 50개 시나리오와 RanSim 실행이 순차적으로 진행되며, 추가 입력 없이 결과 파일이 생성됩니다.
